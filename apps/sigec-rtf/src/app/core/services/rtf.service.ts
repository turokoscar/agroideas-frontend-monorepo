...
export class RtfService {
  ...
  listarDocumentos = (rtfId: number) => this.oaService.listarDocumentos(rtfId);
  descargarDocumentacionZip = (rtfId: number) => this.oaService.descargarDocumentacionZip(rtfId);
